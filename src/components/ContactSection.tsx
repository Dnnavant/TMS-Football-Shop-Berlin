          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Beckerstraße 25<br />12157 Berlin</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  <a href="tel:+493085506915" className="hover:text-black transition-colors">
                    +49 (0) 30 / 855 06 915
                  </a>
                </p>
              </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  <a href="mailto:info@tms-footballshop-berlin.de" className="hover:text-black transition-colors">
                    info@tms-footballshop-berlin.de
                  </a>
                </p>
              </div>
            </div>
